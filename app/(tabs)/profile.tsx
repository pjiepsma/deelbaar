...
// // import Store from '~/components/supabase/Store';
//
...
//   // const { data: creator, isLoading, isError: isErrorCreators } = useGetUserById(user.id); // Fetch farovites of User instead of whole user. Filter data by category and use
//
...
//       await system.supabaseConnector.login();
//   };
//
...
//     return (
//       <View>
//         <Text style={styles.subtitle}>Log in to start finding your next gem.</Text>
//         <TouchableOpacity
...
//           <Text style={{ fontFamily: 'mon-b', fontSize: 22 }}>Hi, {firstName}!</Text>
//         </View>
//
...
//           )}
//           {renderListItem('Log out', 'log-out-outline', () => handlePresentModalPress(), false)}
//           {isAdmin &&
...
//         )}
//         <View style={styles.listContainer}>
//           {renderListItem('Settings', 'settings-outline', () => navigation.navigate('Settings'))}
//         </View>
//         <Store />
//       </ScrollView>
//     );
