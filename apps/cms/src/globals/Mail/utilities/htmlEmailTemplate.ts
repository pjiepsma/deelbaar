...
export async function buildHtmlEmailTemplate({ title, body, headerLogoUrl, footerLogoUrl }: GenerateEmailBodyArgs): Promise<string> {
    ...
    return template
        ...
        .replaceAll('[[origin]]', process.env.PAYLOAD_PUBLIC_SERVER_URL || '');
}
