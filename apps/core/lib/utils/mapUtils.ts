...
/**
 * Map region type (compatible with Mapbox camera)
 */
...
/**
 * Fallback region for the map (default location - Netherlands center)
 */
...
/**
 * Convert latitudeDelta to zoom level (for Mapbox)
 */
